...
Week-by-week build log for IDX Exchange: what was added, the debugging
challenges hit along the way, and the reasoning behind each decision. See the
[project README](../README.md) for setup and API reference.
